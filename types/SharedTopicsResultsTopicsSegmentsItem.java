...
@JsonDeserialize(
    builder = SharedTopicsResultsTopicsSegmentsItem.Builder.class
)
public final class SharedTopicsResultsTopicsSegmentsItem {
  ...
  private SharedTopicsResultsTopicsSegmentsItem(Optional<String> text, Optional<Double> startWord,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SharedTopicsResultsTopicsSegmentsItem && equalTo((SharedTopicsResultsTopicsSegmentsItem) other);
  }
