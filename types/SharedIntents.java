...
@JsonDeserialize(
    builder = SharedIntents.Builder.class
)
public final class SharedIntents {
  ...
  private SharedIntents(Optional<SharedIntentsResults> results,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SharedIntents && equalTo((SharedIntents) other);
  }
