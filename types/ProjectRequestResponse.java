...
@JsonDeserialize(
    builder = ProjectRequestResponse.Builder.class
)
public final class ProjectRequestResponse {
  ...
  private ProjectRequestResponse(Optional<String> requestId, Optional<String> projectUuid,
      Optional<OffsetDateTime> created, Optional<String> path, Optional<String> apiKeyId,
      Optional<Map<String, Object>> response, Optional<Double> code, Optional<String> deployment,
      Optional<String> callback, Map<String, Object> additionalProperties) {
  ...
  private boolean equalTo(ProjectRequestResponse other) {
    return requestId.equals(other.requestId) && projectUuid.equals(other.projectUuid) && created.equals(other.created) && path.equals(other.path) && apiKeyId.equals(other.apiKeyId) && response.equals(other.response) && code.equals(other.code) && deployment.equals(other.deployment) && callback.equals(other.callback);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.requestId, this.projectUuid, this.created, this.path, this.apiKeyId, this.response, this.code, this.deployment, this.callback);
  }
  ...
  public static final class Builder {
    ...
    public ProjectRequestResponse build() {
      return new ProjectRequestResponse(requestId, projectUuid, created, path, apiKeyId, response, code, deployment, callback, additionalProperties);
    }
  }
}
