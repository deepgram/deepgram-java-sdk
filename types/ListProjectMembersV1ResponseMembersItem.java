...
@JsonDeserialize(
    builder = ListProjectMembersV1ResponseMembersItem.Builder.class
)
public final class ListProjectMembersV1ResponseMembersItem {
  ...
  private ListProjectMembersV1ResponseMembersItem(Optional<String> memberId, Optional<String> email,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof ListProjectMembersV1ResponseMembersItem && equalTo((ListProjectMembersV1ResponseMembersItem) other);
  }
