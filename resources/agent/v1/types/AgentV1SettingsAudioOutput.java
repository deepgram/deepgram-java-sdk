...
@JsonDeserialize(
    builder = AgentV1SettingsAudioOutput.Builder.class
)
public final class AgentV1SettingsAudioOutput {
  ...
  private AgentV1SettingsAudioOutput(Optional<AgentV1SettingsAudioOutputEncoding> encoding,
      Optional<Double> sampleRate, Optional<Double> bitrate, Optional<String> container,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AgentV1SettingsAudioOutput && equalTo((AgentV1SettingsAudioOutput) other);
  }
  ...
  private boolean equalTo(AgentV1SettingsAudioOutput other) {
    return encoding.equals(other.encoding) && sampleRate.equals(other.sampleRate) && bitrate.equals(other.bitrate) && container.equals(other.container);
  }
  ...
  public static final class Builder {
    ...
    /**
     * <p>Audio encoding format for streaming TTS output</p>
     */
    @JsonSetter(
        value = "encoding",
        nulls = Nulls.SKIP
    ...
    public AgentV1SettingsAudioOutput build() {
      return new AgentV1SettingsAudioOutput(encoding, sampleRate, bitrate, container, additionalProperties);
    }
  }
}
