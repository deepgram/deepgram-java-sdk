...
@JsonDeserialize(
    builder = SpeakV1Metadata.Builder.class
)
public final class SpeakV1Metadata {
  ...
  private SpeakV1Metadata(String requestId, String modelName, String modelVersion, String modelUuid,
  ...
  private boolean equalTo(SpeakV1Metadata other) {
    return requestId.equals(other.requestId) && modelName.equals(other.modelName) && modelVersion.equals(other.modelVersion) && modelUuid.equals(other.modelUuid);
  }
  ...
  public static final class Builder implements RequestIdStage, ModelNameStage, ModelVersionStage, ModelUuidStage, _FinalStage {
