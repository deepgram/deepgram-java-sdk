...
package resources.speak.v1.websocket;
...
import resources.speak.v1.types.SpeakV1Clear;
import resources.speak.v1.types.SpeakV1Cleared;
import resources.speak.v1.types.SpeakV1Close;
import resources.speak.v1.types.SpeakV1Flush;
import resources.speak.v1.types.SpeakV1Flushed;
import resources.speak.v1.types.SpeakV1Metadata;
import resources.speak.v1.types.SpeakV1Text;
import resources.speak.v1.types.SpeakV1Warning;
...
public class V1WebSocketClient implements AutoCloseable {
  ...
  public CompletableFuture<Void> connect(V1ConnectOptions options) {
    ...
    if (options.getModel() != null && options.getModel().isPresent()) {
      urlBuilder.addQueryParameter("model", String.valueOf(options.getModel().get()));
    }
