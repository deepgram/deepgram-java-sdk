...
package resources.agent.v1.websocket;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import core.ClientOptions;
import core.DisconnectReason;
import core.ObjectMappers;
import core.ReconnectingWebSocketListener;
import core.WebSocketReadyState;
...
import resources.agent.v1.types.AgentV1AgentAudioDone;
import resources.agent.v1.types.AgentV1AgentStartedSpeaking;
import resources.agent.v1.types.AgentV1AgentThinking;
import resources.agent.v1.types.AgentV1ConversationText;
import resources.agent.v1.types.AgentV1Error;
import resources.agent.v1.types.AgentV1FunctionCallRequest;
import resources.agent.v1.types.AgentV1InjectAgentMessage;
import resources.agent.v1.types.AgentV1InjectUserMessage;
import resources.agent.v1.types.AgentV1InjectionRefused;
import resources.agent.v1.types.AgentV1KeepAlive;
import resources.agent.v1.types.AgentV1PromptUpdated;
import resources.agent.v1.types.AgentV1ReceiveFunctionCallResponse;
import resources.agent.v1.types.AgentV1SendFunctionCallResponse;
import resources.agent.v1.types.AgentV1Settings;
import resources.agent.v1.types.AgentV1SettingsApplied;
import resources.agent.v1.types.AgentV1SpeakUpdated;
import resources.agent.v1.types.AgentV1ThinkUpdated;
import resources.agent.v1.types.AgentV1UpdatePrompt;
import resources.agent.v1.types.AgentV1UpdateSpeak;
import resources.agent.v1.types.AgentV1UpdateThink;
import resources.agent.v1.types.AgentV1UserStartedSpeaking;
import resources.agent.v1.types.AgentV1Warning;
import resources.agent.v1.types.AgentV1Welcome;

/**
 * WebSocket client for the v1 channel. Provides real-time bidirectional communication with
...
public class V1WebSocketClient implements AutoCloseable {
  ...
  public CompletableFuture<Void> connect() {
    ...
    ReconnectingWebSocketListener.ReconnectOptions reconnectOpts =
   ...
   *
   * <p>This provides the actual connection state, similar to the W3C WebSocket API.
   *
  ...
  /**
   * Registers a handler called for every incoming text message. The handler receives the raw JSON
   * string before type-specific dispatch.
   *
  ...
  /**
   * Closes this WebSocket client, releasing all resources. Equivalent to calling {@link
   * #disconnect()}.
   */
  @Override
  public void close() {
      ...
      switch (type) {
        ...
        case "InjectionRefused":
          if (injectionRefusedHandler != null) {
            AgentV1InjectionRefused event =
                objectMapper.treeToValue(node, AgentV1InjectionRefused.class);
            if (event != null) {
        ...
        case "SettingsApplied":
          if (settingsAppliedHandler != null) {
            AgentV1SettingsApplied event =
                objectMapper.treeToValue(node, AgentV1SettingsApplied.class);
            if (event != null) {
        ...
        case "ConversationText":
          if (conversationTextHandler != null) {
            AgentV1ConversationText event =
                objectMapper.treeToValue(node, AgentV1ConversationText.class);
            if (event != null) {
        ...
        case "AgentAudioDone":
          if (agentAudioDoneHandler != null) {
            AgentV1AgentAudioDone event =
                objectMapper.treeToValue(node, AgentV1AgentAudioDone.class);
            if (event != null) {
