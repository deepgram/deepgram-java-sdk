...
public class AsyncRawBreakdownClient {
  ...
  public CompletableFuture<DeepgramApiHttpResponse<UsageBreakdownV1Response>> get(
    ...
    return get(projectId, BreakdownGetRequest.builder().build(), requestOptions);
  }
   ...
   */
  public CompletableFuture<DeepgramApiHttpResponse<UsageBreakdownV1Response>> get(
      String projectId, BreakdownGetRequest request) {
  ...
  public CompletableFuture<DeepgramApiHttpResponse<UsageBreakdownV1Response>> get(
    ...
    if (request.getAlternatives().isPresent()) {
      QueryStringMapper.addQueryParameter(
          httpUrl, "alternatives", request.getAlternatives().get(), false);
    }
    ...
    if (request.getCustomIntent().isPresent()) {
      QueryStringMapper.addQueryParameter(
          httpUrl, "custom_intent", request.getCustomIntent().get(), false);
    }
    ...
    if (request.getCustomTopic().isPresent()) {
      QueryStringMapper.addQueryParameter(
          httpUrl, "custom_topic", request.getCustomTopic().get(), false);
    }
    ...
    CompletableFuture<DeepgramApiHttpResponse<UsageBreakdownV1Response>> future =
                    ...
                    future.complete(
                        new DeepgramApiHttpResponse<>(
                            ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, UsageBreakdownV1Response.class),
                            response));
                    return;
                  }
                  try {
