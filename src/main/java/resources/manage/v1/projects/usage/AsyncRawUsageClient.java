...
public class AsyncRawUsageClient {
   ...
   * comprehensive usage summary.
   */
  public CompletableFuture<DeepgramApiHttpResponse<UsageV1Response>> get(
      String projectId, RequestOptions requestOptions) {
    return get(projectId, UsageGetRequest.builder().build(), requestOptions);
  }
   ...
   */
  public CompletableFuture<DeepgramApiHttpResponse<UsageV1Response>> get(
      String projectId, UsageGetRequest request) {
                    ...
                    future.complete(
                        new DeepgramApiHttpResponse<>(
                            ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, UsageV1Response.class),
                            response));
                    return;
                  }
                  try {
