...
import resources.listen.v1.types.ListenV1Finalize;
import resources.listen.v1.types.ListenV1KeepAlive;
import resources.listen.v1.types.ListenV1Metadata;
import resources.listen.v1.types.ListenV1Results;
import resources.listen.v1.types.ListenV1SpeechStarted;
import resources.listen.v1.types.ListenV1UtteranceEnd;
...
public class V1WebSocketClient implements AutoCloseable {
  ...
  public CompletableFuture<Void> connect(V1ConnectOptions options) {
    ...
    if (options.getCallback() != null && options.getCallback().isPresent()) {
      urlBuilder.addQueryParameter("callback", String.valueOf(options.getCallback().get()));
    }
    if (options.getCallbackMethod() != null && options.getCallbackMethod().isPresent()) {
      urlBuilder.addQueryParameter(
          "callback_method", String.valueOf(options.getCallbackMethod().get()));
    }
    if (options.getChannels() != null && options.getChannels().isPresent()) {
      urlBuilder.addQueryParameter("channels", String.valueOf(options.getChannels().get()));
    }
    if (options.getDetectEntities() != null && options.getDetectEntities().isPresent()) {
      urlBuilder.addQueryParameter(
          "detect_entities", String.valueOf(options.getDetectEntities().get()));
    }
    ...
    if (options.getDictation() != null && options.getDictation().isPresent()) {
      urlBuilder.addQueryParameter("dictation", String.valueOf(options.getDictation().get()));
    }
    ...
    if (options.getExtra() != null && options.getExtra().isPresent()) {
      urlBuilder.addQueryParameter("extra", String.valueOf(options.getExtra().get()));
    }
    if (options.getInterimResults() != null && options.getInterimResults().isPresent()) {
      urlBuilder.addQueryParameter(
          "interim_results", String.valueOf(options.getInterimResults().get()));
    }
    ...
    if (options.getMipOptOut() != null && options.getMipOptOut().isPresent()) {
      urlBuilder.addQueryParameter("mip_opt_out", String.valueOf(options.getMipOptOut().get()));
    }
    ...
    if (options.getMultichannel() != null && options.getMultichannel().isPresent()) {
      urlBuilder.addQueryParameter("multichannel", String.valueOf(options.getMultichannel().get()));
    }
    if (options.getNumerals() != null && options.getNumerals().isPresent()) {
      urlBuilder.addQueryParameter("numerals", String.valueOf(options.getNumerals().get()));
    }
    if (options.getProfanityFilter() != null && options.getProfanityFilter().isPresent()) {
      urlBuilder.addQueryParameter(
          "profanity_filter", String.valueOf(options.getProfanityFilter().get()));
    }
    ...
    if (options.getRedact() != null && options.getRedact().isPresent()) {
      urlBuilder.addQueryParameter("redact", String.valueOf(options.getRedact().get()));
    }
    if (options.getReplace() != null && options.getReplace().isPresent()) {
      urlBuilder.addQueryParameter("replace", String.valueOf(options.getReplace().get()));
    }
    ...
    if (options.getSearch() != null && options.getSearch().isPresent()) {
      urlBuilder.addQueryParameter("search", String.valueOf(options.getSearch().get()));
    }
    if (options.getSmartFormat() != null && options.getSmartFormat().isPresent()) {
      urlBuilder.addQueryParameter("smart_format", String.valueOf(options.getSmartFormat().get()));
    }
    ...
    if (options.getUtteranceEndMs() != null && options.getUtteranceEndMs().isPresent()) {
      urlBuilder.addQueryParameter(
          "utterance_end_ms", String.valueOf(options.getUtteranceEndMs().get()));
    }
    ...
    if (options.getVersion() != null && options.getVersion().isPresent()) {
      urlBuilder.addQueryParameter("version", String.valueOf(options.getVersion().get()));
    }
      ...
      switch (type) {
        ...
        case "SpeechStarted":
          if (speechStartedHandler != null) {
            ListenV1SpeechStarted event =
                objectMapper.treeToValue(node, ListenV1SpeechStarted.class);
            if (event != null) {
