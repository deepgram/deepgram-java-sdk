...
public final class DeepgramListenProviderV2 {
    ...
    /**
     * @return End-of-turn confidence required to finish a turn. Valid range: 0.5 - 1.0. Defaults to 0.7. Set to 1.0 to fully suppress confidence-based end-of-turn detection. <code>eot_timeout_ms</code> still ends idle turns; increase it when using ForceEndTurn for full manual turn control.
     */
    ...
    public interface _FinalStage {
        ...
        /**
         * <p>End-of-turn confidence required to finish a turn. Valid range: 0.5 - 1.0. Defaults to 0.7. Set to 1.0 to fully suppress confidence-based end-of-turn detection. <code>eot_timeout_ms</code> still ends idle turns; increase it when using ForceEndTurn for full manual turn control.</p>
         */
