...
public final class ListenV1ResponseMetadataDiarizeInfo {
    ...
    private final ListenV1ResponseMetadataDiarizeInfoArch arch;

    private final Map<String, Object> additionalProperties;

    private ListenV1ResponseMetadataDiarizeInfo(
            String modelUuid, ListenV1ResponseMetadataDiarizeInfoArch arch, Map<String, Object> additionalProperties) {
     ...
     */
    @JsonProperty("arch")
    public ListenV1ResponseMetadataDiarizeInfoArch getArch() {
        return arch;
    }
    ...
    public interface ArchStage {
         ...
         */
        _FinalStage arch(@NotNull ListenV1ResponseMetadataDiarizeInfoArch arch);
    }
    ...
    public static final class Builder implements ModelUuidStage, ArchStage, _FinalStage {
        ...
        private ListenV1ResponseMetadataDiarizeInfoArch arch;
        ...
        @java.lang.Override
        @JsonSetter("arch")
        public _FinalStage arch(@NotNull ListenV1ResponseMetadataDiarizeInfoArch arch) {
