...
public class AsyncRawBreakdownClient {
    ...
    public CompletableFuture<DeepgramApiHttpResponse<UsageBreakdownV1Response>> get(
        ...
        if (request.getGrouping().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "grouping", request.getGrouping().get(), false);
        }
        ...
        if (request.getChannels().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "channels", request.getChannels().get(), false);
        }
        ...
        if (request.getKeyterm().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "keyterm", request.getKeyterm().get(), false);
        }
        if (request.getKeywords().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "keywords", request.getKeywords().get(), false);
        }
        ...
        if (request.getReplace().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "replace", request.getReplace().get(), false);
        }
