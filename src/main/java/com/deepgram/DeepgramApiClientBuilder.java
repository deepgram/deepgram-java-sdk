...
public class DeepgramApiClientBuilder {
     ...
     */
    public DeepgramApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public DeepgramApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public DeepgramApiClientBuilder retryJitterFactor(double retryJitterFactor) {
