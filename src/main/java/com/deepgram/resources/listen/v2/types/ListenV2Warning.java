...
public final class ListenV2Warning {
    ...
    private ListenV2Warning(String code, String description, Map<String, Object> additionalProperties) {
        this.code = code;
    ...
    public static final class Builder implements CodeStage, DescriptionStage, _FinalStage {
        ...
        public ListenV2Warning build() {
            return new ListenV2Warning(code, description, additionalProperties);
        }
