...
@JsonDeserialize(builder = AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs.Builder.class)
public final class AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs {
    private final Optional<String> version;

    private final AgentV1UpdateSpeakSpeakOneItemProviderElevenLabsModelId modelId;
    ...
    private AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs(
            ...
            AgentV1UpdateSpeakSpeakOneItemProviderElevenLabsModelId modelId,
    ...
    public AgentV1UpdateSpeakSpeakOneItemProviderElevenLabsModelId getModelId() {
        return modelId;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs
                && equalTo((AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs) other);
    }
    ...
    private boolean equalTo(AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs other) {
    ...
    public interface ModelIdStage {
         ...
         */
        _FinalStage modelId(@NotNull AgentV1UpdateSpeakSpeakOneItemProviderElevenLabsModelId modelId);

        Builder from(AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs other);
    }

    public interface _FinalStage {
        AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs build();
    ...
    public static final class Builder implements ModelIdStage, _FinalStage {
        private AgentV1UpdateSpeakSpeakOneItemProviderElevenLabsModelId modelId;
        ...
        @java.lang.Override
        public Builder from(AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs other) {
        ...
        @java.lang.Override
        @JsonSetter("model_id")
        public _FinalStage modelId(@NotNull AgentV1UpdateSpeakSpeakOneItemProviderElevenLabsModelId modelId) {
        ...
        @java.lang.Override
        public AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs build() {
            return new AgentV1UpdateSpeakSpeakOneItemProviderElevenLabs(
