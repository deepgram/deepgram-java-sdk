...
public final class AgentV1UpdateListenListenProvider {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private AgentV1UpdateListenListenProvider(Value value) {
        this.value = value;
    }
    ...
    public static AgentV1UpdateListenListenProvider v1(DeepgramListenProviderV1 value) {
        return new AgentV1UpdateListenListenProvider(new V1Value(value));
    }

    public static AgentV1UpdateListenListenProvider v2(DeepgramListenProviderV2 value) {
        return new AgentV1UpdateListenListenProvider(new V2Value(value));
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AgentV1UpdateListenListenProvider
                && value.equals(((AgentV1UpdateListenListenProvider) other).value);
    }
    ...
    private static final class V1Value implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "AgentV1UpdateListenListenProvider{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "AgentV1UpdateListenListenProvider{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
