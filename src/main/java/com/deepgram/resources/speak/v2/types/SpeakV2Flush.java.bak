...
@JsonDeserialize(builder = SpeakV2Flush.Builder.class)
public final class SpeakV2Flush {
    private final Map<String, Object> additionalProperties;

    private SpeakV2Flush(Map<String, Object> additionalProperties) {
    ...
    public static final class Builder {
        ...
        public Builder from(SpeakV2Flush other) {
            return this;
        }

        public SpeakV2Flush build() {
            return new SpeakV2Flush(additionalProperties);
        }
