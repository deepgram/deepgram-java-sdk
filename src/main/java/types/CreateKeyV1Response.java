...
public final class CreateKeyV1Response {
  ...
  public int hashCode() {
    return Objects.hash(
        this.apiKeyId, this.key, this.comment, this.scopes, this.tags, this.expirationDate);
  }
  ...
  public static final class Builder {
    ...
    public CreateKeyV1Response build() {
      return new CreateKeyV1Response(
          apiKeyId, key, comment, scopes, tags, expirationDate, additionalProperties);
    }
