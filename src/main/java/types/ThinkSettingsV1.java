...
public final class ThinkSettingsV1 {
  ...
  /**
   * @return Optional for non-Deepgram LLM providers. When present, must include url field and
   *     headers object
   */
  ...
  /**
   * @return Specifies the number of characters retained in context between user messages, agent
   *     responses, and function calls. This setting is only configurable when a custom think
   *     endpoint is used
   */
  ...
  public int hashCode() {
    return Objects.hash(
        this.provider, this.endpoint, this.functions, this.prompt, this.contextLength);
  }
  ...
  public interface _FinalStage {
    ...
    /**
     * Optional for non-Deepgram LLM providers. When present, must include url field and headers
     * object
     */
    ...
    /**
     * Specifies the number of characters retained in context between user messages, agent
     * responses, and function calls. This setting is only configurable when a custom think endpoint
     * is used
     */
