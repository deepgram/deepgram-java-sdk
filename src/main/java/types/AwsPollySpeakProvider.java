...
public final class AwsPollySpeakProvider {
  ...
  /**
   * @return Language code to use, e.g. 'en-US'. Corresponds to the <code>language_code</code>
   *     parameter in the AWS Polly API
   */
  ...
  public int hashCode() {
    return Objects.hash(
        this.voice, this.language, this.languageCode, this.engine, this.credentials);
  }
  ...
  public interface LanguageStage {
    /**
     * Language code to use, e.g. 'en-US'. Corresponds to the <code>language_code</code> parameter
     * in the AWS Polly API
     */
  ...
  public static final class Builder
      implements VoiceStage, LanguageStage, EngineStage, CredentialsStage, _FinalStage {
     ...
     * in the AWS Polly API
     *
     * <p>Language code to use, e.g. 'en-US'. Corresponds to the <code>language_code</code>
     * parameter in the AWS Polly API
     *
     * @return Reference to {@code this} so that method calls can be chained together.
     */
    ...
    public AwsPollySpeakProvider build() {
      return new AwsPollySpeakProvider(
