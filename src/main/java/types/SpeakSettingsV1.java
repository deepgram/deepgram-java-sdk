...
public final class SpeakSettingsV1 {
  ...
  /**
   * @return Optional if provider is Deepgram. Required for non-Deepgram TTS providers. When
   *     present, must include url field and headers object. Valid schemes are https and wss with
   *     wss only supported for Eleven Labs.
   */
  ...
  public interface _FinalStage {
    ...
    /**
     * Optional if provider is Deepgram. Required for non-Deepgram TTS providers. When present, must
     * include url field and headers object. Valid schemes are https and wss with wss only supported
     * for Eleven Labs.
     */
