...
public final class ListenV1CallbackMethod {
  public static final ListenV1CallbackMethod DELETE =
      new ListenV1CallbackMethod(Value.DELETE, "DELETE");
  ...
  public boolean equals(Object other) {
    return (this == other)
        || (other instanceof ListenV1CallbackMethod
            && this.string.equals(((ListenV1CallbackMethod) other).string));
  }
