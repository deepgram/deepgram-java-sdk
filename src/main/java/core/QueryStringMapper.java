...
public class QueryStringMapper {
  ...
  public static void addQueryParameter(
      HttpUrl.Builder httpUrl, String key, Object value, boolean arraysAsRepeats) {
  ...
  public static List<Map.Entry<String, JsonNode>> flattenObject(
      ObjectNode object, boolean arraysAsRepeats) {
  ...
  private static List<Map.Entry<String, JsonNode>> flattenArray(
    ...
    while (elements.hasNext()) {
      ...
      if (element.isObject()) {
        List<Map.Entry<String, JsonNode>> flatField =
            flattenObject((ObjectNode) element, arraysAsRepeats);
        addAll(flat, flatField, indexKey);
      } else if (element.isArray()) {
        List<Map.Entry<String, JsonNode>> flatField =
            flattenArray((ArrayNode) element, "", arraysAsRepeats);
        addAll(flat, flatField, indexKey);
      } else {
  ...
  private static void addAll(
      List<Map.Entry<String, JsonNode>> target,
      List<Map.Entry<String, JsonNode>> source,
      String prefix) {
