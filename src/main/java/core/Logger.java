 ...
 *
 * <p>Silent by default — no log output unless explicitly configured. Create via {@link LogConfig}
 * or directly:
 *
 * <pre>{@code
...
public final class Logger {
  ...
  /**
   * Creates a Logger from a {@link LogConfig}. If config is {@code null}, returns the default
   * silent logger.
   */
  ...
  /**
   * Creates a Logger from an {@code Optional<LogConfig>}. If empty, returns the default silent
   * logger.
   */
