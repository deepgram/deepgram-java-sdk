 ...
 *
 * <p>This class extends FilterInputStream and takes an OkHttp Response object as a parameter. It
 * retrieves the InputStream from the Response and overrides the close method to close both the
 * InputStream and the Response object, ensuring proper resource management and preventing premature
 * closure of the underlying HTTP connection.
 */
public class ResponseBodyInputStream extends FilterInputStream {
  private final Response response;

  /**
   * Constructs a ResponseBodyInputStream that wraps the InputStream from the given OkHttp Response
   * object.
   *
