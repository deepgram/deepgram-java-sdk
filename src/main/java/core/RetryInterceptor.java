...
public class RetryInterceptor implements Interceptor {
  ...
  private Duration getRetryDelayFromHeaders(Response response, int retryAttempt) {
    ...
    if (retryAfter != null) {
      ...
      Optional<Duration> secondsDelay =
          tryParseLong(retryAfter)
      ...
      Optional<Duration> dateDelay =
          tryParseHttpDate(retryAfter)
  ...
  /**
   * Adds positive jitter (100-120% of original value) to prevent thundering herd. Used for
   * X-RateLimit-Reset header delays.
   */
  ...
  /**
   * Adds symmetric jitter (90-110% of original value) to prevent thundering herd. Used for
