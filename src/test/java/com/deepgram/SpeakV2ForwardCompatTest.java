...
/**
 * Forward-compatibility guard for the Speak v2 (Flux) WebSocket dispatcher.
 *
 ...
 * Mirrors the JS/Python SDKs and guards against the Mar 2026 breakage class.
 *
 * <p>Drives the private {@code handleIncomingMessage} dispatcher directly (no network) via reflection.
 */
public class SpeakV2ForwardCompatTest {
